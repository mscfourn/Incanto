define(["storymaps/ui/inlineFieldEdit/InlineFieldEdit", "dojo/has"], function(InlineFieldEdit, has){
	...
	return function Header(selector, isInBuilderMode)
	{
		...
		this.init = function(title, subtitle, bgColor, logoURL, logoTarget, displaySwitchBuilderButton)
		{
		...
		this.initLocalization = function()
		{
			...
			dojo.query('.switchBuilder')[0].innerHTML = '<div></div>' + i18n.viewer.desktopHTML.builderButton;
		}
	}
});